    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    <li class="<?php echo ($uri->getSegment(2) == '' ? 'active' : ''); ?>">
                    ...
                    ?>
                        ...
                        <li class="<?php echo ($uri->getSegment(2) == 'dashboard' ? 'active' : ''); ?>">
                            <a href="<?php echo base_url('dashboard'); ?>" class="text-danger">Dashboard</a>
                        </li>

                    <?php } else { ?>

                        <li class="<?php echo ($uri->getSegment(2) == 'login' ? 'active' : ''); ?>">
