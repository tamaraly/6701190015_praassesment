            ...
            <div class="row content justify-content-center" style="min-height:480px;">
                <div class="col-md-12 mt-5 mb-5 pb-5" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        ...
                        <div class="card-body">    
                            <form action="<?php echo base_url('karyawan/update')?>" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="nip" id="nip" placeholder="Masukkan NIP/Username" class="form-control" value="<?php echo (set_value('nip') ? set_value('nip') : $edit['nip']);?>">
                                    </div>
                                </div>
                                <div class="form-group row">
