            ...
            <div class="row content justify-content-center" style="min-height:480px;">
                <div class="col-md-12 mt-5 mb-5 pb-5" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        ...
                        <div class="card-body">    
                            <form action="<?php echo base_url('paket/store')?>" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <textarea class="form-control" name="isi_paket" id="isi_paket" rows="5" required><?php echo set_value('isi_paket');?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <select name="penghunis_id" id="penghunis_id" class="form-control" required>
                                            ...
                                            if($penghuni)
                                            {
                                                ...
                                                {
                                                    $selected = ($row['id'] == set_value('penghunis_id') ? 'selected' : '');
