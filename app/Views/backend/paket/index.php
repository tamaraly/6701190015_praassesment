                ...
                <div class="col-md-12 mt-5 mb-5 pb-5" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url('paket/create');?>" title="Tambah Data" class="btn btn-primary mb-2">
                                                ...
                                                foreach($paket as $row)
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            '.($row['tanggal_datang'] && $row['tanggal_datang'] != '0000-00-00' ? date('d M Y', strtotime($row['tanggal_datang'])) : '-').'
                                                        </td>
                                                        <td>
                                                            '.nl2br($row['isi_paket']).'
                                                        </td>
                                                        ...
                                                        <td class="text-center">
                                                            '.($row['tanggal_ambil'] && $row['tanggal_ambil'] != '0000-00-00' ? date('d M Y', strtotime($row['tanggal_ambil'])) : '-').'
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="'.base_url('paket/edit/' . $row['id']).'" class="btn btn-warning" title="Ubah Data">
                                                                <i class="bx bx-edit"></i>
                                                            </a>
                                                            <a href="'.base_url('paket/delete/' . $row['id']).'" class="btn btn-danger" title="Hapus Data" onclick="return confirm(\'ANDA YAKIN INGIN MENGHAPUS DATA INI?\')">
